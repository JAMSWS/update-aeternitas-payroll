            ...
            <div class="card-body">
                ...
                <form action="{{ url('aeternitas/employee/'.$employee->id) }}" method="POST">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="timekeeping-tab" data-bs-toggle="tab" data-bs-target="#timekeeping-tab-pane" type="button" role="tab" aria-controls="timekeeping-tab-pane" aria-selected="false">Time Keeping</button>
                        </li>
                    </ul>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" id="month_rate_paid_days" name="month_rate_paid_days" value="{{ $employee->month_rate_paid_days ?? '' }}" class="form-control" required>
